...
const skills = ["Python", "Java", "JavaScript","CSS", "SQL", "Flask", "Jinja2", "Spring Boot", "React","Express","Bootstrap","Material-UI", "Redux", "MySQL", "MongoDB","Mongoose", "AJAX","Spring Tool Suite","REST API", "JSON", "PostMan","Socket.io", "Git", "Github"];
